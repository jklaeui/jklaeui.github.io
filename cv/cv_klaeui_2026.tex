...
\newcommand{\lastupdated}{September 10, 2026}
...
\item Klaeui, ``Which Job Openings Lead to Employment? The Role of the Consideration Scope in Job Search,'' \href{https://api.unil.ch/iris/server/api/core/bitstreams/031700df-f881-4e74-bfe3-51930f2ca265/content#page=28}{PhD chapter, Jun 2024}, \hyperlink{abs:consid}{abstract}.
\end{itemize}
...
\begin{itemize}
\item Referee for: \textit{The Economic Journal}, \textit{Journal of Development Economics}, \textit{Labour Economics}, \textit{RFBerlin Discussion Papers}, \textit{Swiss Journal of Economics and Statistics}.
...
\item Co-founder and manager (part-time  during school and university, on average 30\%), \\jkweb ag, Basel, 2011 -- 2016.
  \begin{itemize}[label=--]
  \item Web design \& web applications company, co-founded at age 17. The company acquired novu and now operates under the name \href{https://novu.ch/}{novu}; it has recently been sold to a larger group. Strategic decisions, project management, client consulting, and web programming in PHP, JS, SQL, HTML.
  \end{itemize}
...
\vspace{8mm}
\hypertarget{abs:consid}{}%
\begin{center}
{\Large\bfseries Which Job Openings Lead to Employment?\\ The Role of the Consideration Scope in Job Search}
\end{center}
